...
public class AtomikosNonXADataSourceBean extends AbstractDataSourceBean {
	...
	protected ConnectionFactory doInit() throws Exception {
		...
		LOGGER.logDebug(
					this + ": initializing with [" + " uniqueResourceName=" + getUniqueResourceName() + "," + " maxPoolSize=" + getMaxPoolSize() + ","
							+ " minPoolSize=" + getMinPoolSize() + "," + " borrowConnectionTimeout=" + getBorrowConnectionTimeout() + ","
							+ " maxIdleTime=" + getMaxIdleTime() + "," + " reapTimeout=" + getReapTimeout() + "," + " maintenanceInterval="
							+ getMaintenanceInterval() + "," + " testQuery=" + getTestQuery() + "," + " driverClassName=" + getDriverClassName() + ","
							+ " user=" + getUser() + "," + " url=" + getUrl() + ", loginTimeout=" + getLoginTimeout() + "]");
	...
	public synchronized Connection getConnection() throws SQLException {
		...
		LOGGER.logInfo("autocommit before set=" + Boolean.toString(proxy.getAutoCommit()));
		proxy.setAutoCommit(false);
		LOGGER.logInfo("autocommit after set=" + Boolean.toString(proxy.getAutoCommit()));
